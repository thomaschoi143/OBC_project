...
// sub-signals: 1Hz, 1/2Hz, and 1/4Hz
NATIVE_INT_TYPE rateGroupDivisors[Svc::RateGroupDriver::DIVIDER_SIZE] = {1, 2,
                                                                         4};
...
Svc::Health::PingEntry pingEntries[] = {
    ...
    {PingEntries::eventLogger::WARN, PingEntries::eventLogger::FATAL,
     "eventLogger"},
    {PingEntries::fileDownlink::WARN, PingEntries::fileDownlink::FATAL,
     "fileDownlink"},
    {PingEntries::fileManager::WARN, PingEntries::fileManager::FATAL,
     "fileManager"},
    {PingEntries::fileUplink::WARN, PingEntries::fileUplink::FATAL,
     "fileUplink"},
    {PingEntries::prmDb::WARN, PingEntries::prmDb::FATAL, "prmDb"},
    {PingEntries::rateGroup1::WARN, PingEntries::rateGroup1::FATAL,
     "rateGroup1"},
    {PingEntries::rateGroup2::WARN, PingEntries::rateGroup2::FATAL,
     "rateGroup2"},
    {PingEntries::rateGroup3::WARN, PingEntries::rateGroup3::FATAL,
     "rateGroup3"},
};
...
void configureTopology() {
    ...
    rateGroupDriver.configure(rateGroupDivisors,
                              FW_NUM_ARRAY_ELEMENTS(rateGroupDivisors));
    ...
    memset(&bufferManagerBins, 0,
           sizeof(bufferManagerBins));  // All non-specified bins are zero

    bufferManagerBins.bins[0].bufferSize =
        1024;  // Buffers in bin 0 are of size 1024
    bufferManagerBins.bins[0].numBuffers =
        10;  // Ten buffers of size 1024 are available in bin 0
    bufferManagerBins.bins[1].bufferSize =
        5120;  // Buffers in bin 1 are of size 5120
    bufferManagerBins.bins[1].numBuffers =
        5;  // Five buffers of size 5120 are available in bin 1

    bufferManager.setup(123, 0, mallocator, bufferManagerBins);
}
