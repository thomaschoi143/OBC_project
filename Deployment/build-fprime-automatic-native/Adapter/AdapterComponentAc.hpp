...
namespace OBC_project {
  ...
  PROTECTED:
    ...
    enum {
      OPCODE_TRANSFER_PACKET = 0x0, /* Transfer a data packet */
    };
  ...
  PROTECTED:
    ...
    //! Handler for command TRANSFER_PACKET
    /* Transfer a data packet */
    virtual void TRANSFER_PACKET_cmdHandler(
  ...
  PROTECTED:
    ...
    //! Pre-message hook for command TRANSFER_PACKET
    //!
    virtual void TRANSFER_PACKET_preMsgHook(
        FwOpcodeType opCode, /*!< The opcode*/
        U32 cmdSeq /*!< The command sequence number*/
    );
  ...
  PROTECTED:
    ...
    //! Base-class handler function for command TRANSFER_PACKET
    //!
    void TRANSFER_PACKET_cmdHandlerBase(
        FwOpcodeType opCode, /*!< The opcode*/
        U32 cmdSeq, /*!< The command sequence number*/
  ...
  PROTECTED:
    ...
    enum {
      EVENTID_COMMAND_RECV = 0x0, /* Packet received */
    };
