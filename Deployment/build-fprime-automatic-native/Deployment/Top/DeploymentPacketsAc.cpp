...
namespace Deployment {
  ...
  static const Svc::TlmPacketizerChannelEntry CDHList[] = {
      ...
      {768, 4}, // rateGroup2.RgMaxTime
      {1024, 4}, // rateGroup3.RgMaxTime
  ...
  static const Svc::TlmPacketizerChannelEntry CDHErrorsList[] = {
      ...
      {769, 4}, // rateGroup2.RgCycleSlips
      {1025, 4}, // rateGroup3.RgCycleSlips
  ...
  const Svc::TlmPacketizerPacketList DeploymentPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  static const Svc::TlmPacketizerChannelEntry ignoreList[] = {
      ...
      {3584, 0}, // packetSender.PacketCount
  };

  const Svc::TlmPacketizerPacket DeploymentPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };
