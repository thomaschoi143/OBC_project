// ======================================================================
// \title  DeploymentTopologyAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for Deployment topology
// ======================================================================
...
namespace Deployment {
  ...
  OBC_project::Adapter adapter(FW_OPTIONAL_NAME("adapter"));
  ...
  OBC_project::PacketSender packetSender(FW_OPTIONAL_NAME("packetSender"));
  ...
  void initComponents(const TopologyState& state) {
    adapter.init(QueueSizes::adapter, InstanceIds::adapter);
    ...
    packetSender.init(QueueSizes::packetSender, InstanceIds::packetSender);
  ...
  void setBaseIds() {
    ...
    packetSender.setIdBase(BaseIds::packetSender);
    health.setIdBase(BaseIds::health);
    adapter.setIdBase(BaseIds::adapter);
  ...
  void connectComponents() {
    ...
    cmdDisp.set_compCmdSend_OutputPort(
        6,
        packetSender.get_cmdIn_InputPort(0)
    );
    cmdDisp.set_compCmdSend_OutputPort(
        7,
    ...
    packetSender.set_cmdRegOut_OutputPort(
        0,
    ...
    packetSender.set_cmdResponseOut_OutputPort(
        0,
        cmdDisp.get_compCmdStat_InputPort(0)
    );
    ...
    // Deployment
    adapter.set_transferResultOut_OutputPort(
        0,
        packetSender.get_transferResult_InputPort(0)
    );
    packetSender.set_packetTransfer_OutputPort(
        0,
        adapter.get_packetIn_InputPort(0)
    );
    ...
    packetSender.set_logOut_OutputPort(
        0,
        eventLogger.get_LogRecv_InputPort(0)
    );
    ...
    rateGroup1.set_RateGroupMemberOut_OutputPort(
        3,
        adapter.get_schedIn_InputPort(0)
    );
    ...
    packetSender.set_tlmOut_OutputPort(
        0,
        tlmSend.get_TlmRecv_InputPort(0)
    );
    ...
    // TextEvents
    adapter.set_logTextOut_OutputPort(
        0,
    ...
    packetSender.set_logTextOut_OutputPort(
        0,
        textLogger.get_TextLogger_InputPort(0)
    );
    ...
    // Time
    adapter.set_timeCaller_OutputPort(
        0,
    ...
    packetSender.set_timeCaller_OutputPort(
        0,
        linuxTime.get_timeGetPort_InputPort(0)
    );
  ...
  void startTasks(const TopologyState& state) {
    ...
    packetSender.start(
      static_cast<NATIVE_UINT_TYPE>(Priorities::packetSender),
      static_cast<NATIVE_UINT_TYPE>(StackSizes::packetSender),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<NATIVE_UINT_TYPE>(TaskIds::packetSender)
    );
    prmDb.start(
  ...
  void freeThreads(const TopologyState& state) {
    ...
    (void) packetSender.ActiveComponentBase::join(nullptr);
